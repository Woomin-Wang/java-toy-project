...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bookStore.bookAdd(new Book("급류", "정대건", "민음사", 13000));
        bookStore.bookAdd(new Book("데미안", "헤르만헤세", "민음사", 8000));
        bookStore.bookAdd(new Book("모순", "양귀자", "쓰다", 15000));
        bookStore.bookAdd(new Book("브람스", "프랑수아즈 사강", "민음사", 7000));
        ...
        while(true) {
            ...
            switch(input) {
                ...
                case 4 -> bookStore.showShoppingCart();
